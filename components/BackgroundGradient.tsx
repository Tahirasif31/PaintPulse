    ...
    <div>
      <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-zinc-900 flex flex-col items-center">
        ...
        <p className="text-base sm:text-xl text-neutral-200 mt-3">
          Book now and paint your dreams alive!
        </p>

        <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">
          Secure your spot for a transformative paint experience! Let&apos;s
          craft your dream space with precision and passion. Book now!
        </p>
        <button className="rounded-full pl-4 pr-1 py-1 text-white flex items-center space-x-1 bg-black mt-4 text-xs font-bold dark:bg-zinc-800">
          <a href="https://chatwith.io/s/paint-plues">
            <span>Book now </span>
